...
import { useGetCourseQuery, useGetUploadVideoUrlMutation, useUpdateCourseMutation } from "@/src/state/api";
...
import { createCourseFormData, uploadAllVideos } from "@/src/lib/utils";
...
const CourseEditor = () => {
  ...
  const dispatch = useAppDispatch(); // no need to pass in too much props
  ...
  // standard practice to reset  data if course or methods changes
  useEffect(() => {
    if (course) {
      methods.reset({
